...
import { AppstoreOutlined, HomeOutlined, LaptopOutlined, ProfileOutlined, UserOutlined } from '@ant-design/icons';
...
const Menu = (props: MenuProps) => {
    ...
    const items: MenuItem[] = [
        ...
        },
        {
          ...
          icon: <LaptopOutlined />,
          children: [
            { key: 'product_view', label: 'Lista de Produtos', onClick: () => navigate(ProductRoutesEnum.PRODUCT) },
            { key: 'product_insert', label: 'Cadastrar Produto', onClick: () => navigate(ProductRoutesEnum.PRODUCT_INSERT) },
          ],
        },
        {
          key: 'categories',
    ...
    return (
        <ContainerMenu background={theme === "dark" ? "#001529" : "white"} style={{display: props.display}}>
            <ContainerCompany>
                <LogoMenu />
